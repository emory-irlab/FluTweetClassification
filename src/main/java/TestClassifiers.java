...
*/
        ...
        //classifier.crossValidate(5, pathToTestResultsEvent, "null_class", 0.5);
        //classifier.crossValidate(5, pathToTestResultsEvent, "null_class", new double[] {0.5, 0.6, 0.7, 0.8, 0.9});
        //split multiple times test
